...
Description:
This file contains the prototypes and descriptions of each
function and constructor within the Dragon.cpp file.

Note: 
This .h file was copied directly from Professor Dixon's directory.
*******************************************************************/
